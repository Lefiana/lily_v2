import { 
  ...
  UploadedFile, UseInterceptors, UploadedFiles, BadRequestException, 
  Res 
} from '@nestjs/common';
...
export class TasksController {
  ...
  async search(
    ...
    return this.tasksService.findAll(userId, q);
  }
  ...
  async downloadFile(
    ...
    const attachment = await this.tasksService.getAttachmentForDownload(attachmentId, userId);
